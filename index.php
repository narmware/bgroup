                    ...
                    <div class="service-list">
                        ...
                        <div class="service-caption">
                            ...
                            <div class="service-right">
                                <a href="duct.php"><i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="service-list">
                        ...
                        <div class="service-caption">
                            ...
                            <div class="service-right">
                                <a href="stacks.php"><i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="service-list">
                        ...
                        <div class="service-caption">
                            ...
                            <div class="service-right">
                                <a href="tanks.php"><i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="service-list">
                        ...
                        <div class="service-caption">
                            ...
                            <div class="service-right">
                                <a href="beam.php"><i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
